...
**Letzte Messwerte (01.09.2025 10:50 Uhr):**
- Indoor (ENV III): 21.2°C, 68.6% Luftfeuchtigkeit, 1013.2hPa ✅
- Outdoor (DHT22): 20.6°C, 48.7% Luftfeuchtigkeit ✅
...
- **Pull-up Widerstand**: 4.7-10kΩ zwischen VCC und DATA empfohlen für optimale Stabilität
...
2. **Pull-up Widerstand**: 4.7-10kΩ zwischen VCC (Pin 1) und DATA (Pin 2) installieren für stabile Messungen
3. **Boot-Config prüfen**: `dtoverlay=dht22,gpiopin=4` in `/boot/firmware/config.txt`?
4. **Virtual Environment nutzen**: Immer venv Python verwenden, nicht System-Python!
5. **Neustart**: Nach Config-Änderungen `sudo reboot`
6. **Timing-Probleme**: Der verbesserte Code enthält nun Retry-Logik und 30s Caching
...
Letzte erfolgreiche Messung: 01.09.2025 10:50 Uhr

### Letzte Verbesserungen
#### 01.09.2025
- System läuft stabil mit beiden Sensoren
- DHT22 funktioniert auch ohne externen Pull-up Widerstand (empfohlen für bessere Stabilität)
- Kontinuierliche Datenübertragung alle 60 Sekunden
